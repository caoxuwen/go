...
using JavaScript and `EventSource`.  We will eschew using [`js-stellar-sdk`](https://github.com/caoxuwen/js-stellar-sdk), the
...
> If you need a reliable streaming connection please use our [SDK](https://github.com/caoxuwen/js-stellar-sdk).
