...
[Prebuilt binaries](https://github.com/caoxuwen/go/releases) of the federation server are available on the [releases page](https://github.com/caoxuwen/go/releases).
...
```
go get -u github.com/caoxuwen/go/services/federation
```
